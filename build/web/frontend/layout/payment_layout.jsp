                            ...
                            <div class="vertical_post check_box_agile">
                                ...
                                <div class="checkbox">								
                                    <div class="check_box_one cashon_delivery">
                                        <label class="anim">
                                            <input type="checkbox" class="checkbox codCheckout">
                                            <span> We also accept Credit/Debit card on delivery. Please Check with the agent.</span> 
                                        </label> 
                                    </div>

                                    <div class="text-right mt-5">
                                        <button class="btn btn-outline-primary process_to_cod">Process with cod</button>
                                    </div>
...
<link rel="stylesheet" type="text/css" href="<%= Utils.getBaseUrl(request)%>/frontend/asset/css/easy-responsive-tabs.css " />
<script src="<%= Utils.getBaseUrl(request)%>/frontend/asset/js/easyResponsiveTabs.js"></script>
...
<!-- credit-card -->
<script type="text/javascript" src="<%= Utils.getBaseUrl(request)%>/frontend/asset/js/creditly.js"></script>
<link rel="stylesheet" href="<%= Utils.getBaseUrl(request)%>/frontend/asset/css/creditly.css" type="text/css" media="all" />
...
<script>
    $(".process_to_cod").click(function(){
        let isChecked = $('.codCheckout')[0].checked
        if(isChecked){
            payment("cod")
        }else{
            alert("Please check me to confirm");
        }
    })
</script>
<!-- //credit-card -->