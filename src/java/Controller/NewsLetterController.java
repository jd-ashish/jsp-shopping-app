...
public class NewsLetterController extends HttpServlet {
    ...
    private void Newsletter(HttpServletRequest request, HttpServletResponse response) {
        Newsletter newsletter =  new Newsletter(request.getParameter("email"));
        NewsletterDao.create(request, newsletter);
    }
