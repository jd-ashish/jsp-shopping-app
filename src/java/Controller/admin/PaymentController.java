...
public class PaymentController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(CartDao.getCart(request).size()==0){
            ...
            request.getRequestDispatcher("frontend/payment.jsp").forward(request, response);
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(type.equalsIgnoreCase("cod")){
            OrderProducts.updateCod(request,Utils.getCookies(request,Constent.ORDER_ID).getValue());
        }
    }
