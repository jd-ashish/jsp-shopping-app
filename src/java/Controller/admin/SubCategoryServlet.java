...
public class SubCategoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("../admin/SubCategory/cat_index.jsp").forward(request, response);
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (index == null) {
            ...
            request.getRequestDispatcher("../admin/SubCategory/cat_create.jsp").forward(request, response);
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("type").equals("create_category")) {
            ...
            if (auth.user() == null) {
                ...
                SubCategory category = new SubCategory(Integer.valueOf(bid),Integer.valueOf(request.getParameter("category_id")),request.getParameter("cat_name"), img.get(0));
                subCategoryDao.create(request, category);
                request.getSession().setAttribute("type", "success");
                request.getSession().setAttribute("message", "Brand added successfully");
                response.sendRedirect(Constent.getSubCategoryUrl(request));
            }
