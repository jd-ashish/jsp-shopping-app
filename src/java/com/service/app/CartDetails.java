        ...
        String details = "";
            ...
            for (Cart carts : cartDao.getCart(request)) {
                ...
                details += "                        <tr class=\"rem1\">\n"
                        ...
                        + "                            <td class=\"invert-image\" style=\"width: 50px;\"><a href=\"single.html\"><img widith='20' src=\"img/products/" + productses.getThumbnail() + "\" alt=\" \" class=\"img-responsive\"></a></td>\n"
                        + "                            <td class=\"invert\">\n"
                        + "                                <div class=\"quantity\"> \n"
                        ...
                        + "                                </div>\n"
                        + "                            </td>\n"
                        + "                            <td class=\"invert\">" + productses.getName() + "</td>\n"
                        + "\n"
