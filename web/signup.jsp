...
<html>
    <head>
        ...
        <title>Create account - Signup page</title>
    ...
    <body>
        <form method="post" onsubmit="return signupValidate()">
            <div class="wrapper">
                ...
                <form class="p-3 mt-3">
                    <small class="text-danger signupNameError hide"></small>
                    <div class="form-field d-flex align-items-center">
                        <i class="fas fa-user"></i>
                        <input type="text" name="name" id="signupName" placeholder="Your name">
                        <i class="fas fa-exclamation text-danger mr-3 nameICon hide"></i>
                    </div>
                ...
                <div class="text-center fs-6 mt-3">
                    <a href="#">Have already account ?</a> &nbsp; <a href="<%= Utils.getBaseUrl(request) %>/login">Sign In</a>
                </div>
            </div>
        </form>
